...
import { LatestReviews } from "../BookCheckoutPage/LatestReviews";
        ...
        <div className="dropdown" style={{ cursor: "pointer" }}>
            ...
            <StarsReviews rating={starInput} size={32} />
            {
                ...
                <form method="POST" action="#">
                    ...
                    <div>
                        <button type="button" onClick={()=>props.submitReview(starInput,reviewDescription)}className="btn btn-primary mt-3">Submit Reviews</button>
                    </div>
                </form>
            }
